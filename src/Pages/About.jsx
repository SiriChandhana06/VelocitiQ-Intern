    ...
    <section id="about" className="py-16 bg-[#f3e1f4] dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold text-[#674188] dark:text-[#b994d9]" data-aos="flip-up">About Us</h2>
          <p className="mt-4 text-xl text-gray-600 dark:text-gray-400" data-aos="flip-up">
